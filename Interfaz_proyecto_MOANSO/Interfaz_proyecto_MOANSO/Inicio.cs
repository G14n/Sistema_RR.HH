...
namespace Interfaz_proyecto_MOANSO
{
    public partial class Inicio : Form
    {
        ...
        {
            OpenChildFrom(new Consulta_Evaluacion());
            HideSubMenu();
        ...
        {
            OpenChildFrom(new Consulta_pago());
            HideSubMenu();
        ...
        {
            OpenChildFrom(new Registro_Justificacion());
            HideSubMenu();
        }
        ...
        {
            OpenChildFrom(new Registro_Nomina());
            HideSubMenu();
        }

        private void button7_Click_1(object sender, EventArgs e)
        {
            OpenChildFrom(new Registro_Evaluacion());
            HideSubMenu();
        }
    }
}
