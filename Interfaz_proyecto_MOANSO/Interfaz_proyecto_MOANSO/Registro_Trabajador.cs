    ...
    public partial class Registro_Trabajador : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("SE REGISTRO CORRECTAMENTE", "REGISTRO DE TRABAJADOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("SE MODIFICO CORRECTAMENTE", "MODIFICAR TRABAJADOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("SE ELIMINO CORRECTAMENTE", "ELIMINAR TRABAJADOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error.." + ex);
