...
namespace Interfaz_proyecto_MOANSO
{
    public partial class Registro_Contratacion : Form
    {
        ...
        private void AgregarTrabajador_Click(object sender, EventArgs e)
        {
            ...
            listarContratacion();
            MessageBox.Show("SE REGISTRO CORRECTAMENTE", "REGISTRO DE CONTRATO", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                Contratacion co = new Contratacion();
                co.ID_Trabajador = int.Parse(txtidtrabajador.Text);

                logContratacion.Instancia.DeshabilitarContratacion(co);
                MessageBox.Show("SE ELIMINO CORRECTAMENTE", "ELIMINAR CONTRATO", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            dtpFC.Value= Convert.ToDateTime( filaActual.Cells[2].Value);
